...
<head>
    ...
    <title>Trang chủ - Xem Khoá Học</title>
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index3.html" class="brand-link"> <img
				...
				<span class="brand-text font-weight-light">Quản Lý Khoá Học</span>
			</a>
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%"
                                ...
                                <c:forEach items="${khoahocs}" var="khoahoc">
                                    <tr>
                                        <td>${khoahoc.khMa}</td>
                                        <td>${khoahoc.khTen}</td>
                                        <td>${khoahoc.khNoiDung}</td>
                                        <td><div class="btn-group btn-group-toggle"
                                                 data-toggle="buttons">

                                            <form action="/admin/editcourses/${khoahoc.khMa}" method="get">
                                            <button class="btn">
                                                <i class="fa fa-edit">Sửa</i>
                                            </button>
                                            </form>

                                            <form action="/admin/deletecourses/${khoahoc.khMa}" method="post">
                                            <button class="btn">
