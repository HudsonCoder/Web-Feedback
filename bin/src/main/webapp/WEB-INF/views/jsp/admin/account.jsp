                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%"
                                ...
                                <c:forEach items="${taikhoans}" var="taikhoan" varStatus="count">
                                    <tr>
                                        <td>${count.count}</td>
                                        ...
                                        <td><form action="/admin/editaccount" method="get" class="btn-group btn-group-toggle"
                                                 data-toggle="buttons">
											<input value="${taikhoan.email}" name="email" style="display: none;">
