								...
								<table class="table table-bordered" id="dataTable" width="100%"
									...
									<c:forEach items="${students}" var="student" varStatus="count">
										<tr>
											...
											<td>${student.tkGioiTinh}</td>
											<td>${student.email}</td>

											<td><form action="" method="post" class="btn-group btn-group-toggle"
													  data-toggle="buttons">
                                                <input name="email" value="${student.email}" style="display: none;">
												<button class="btn" type="submit">
													<i class="fa fa-edit">Xoá học viên</i>
												</button>
