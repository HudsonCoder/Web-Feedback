...
<body class="hold-transition sidebar-mini">
	...
	<div id="content-wrapper">
		<div class="content-wrapper">
			...
			<form id="update" method="post" action="" onsubmit="return checkData()">
				<h3>Thêm mới khóa học</h3>
				<label>Mã khóa học</label><input readonly value="${khoahoc.khMa}" type="text" id="makhoa" name="makhoa" class="lop"><br>
				<label>Tên khóa học</label><input value="${khoahoc.khTen}" type="text" id="tenkhoa" name="tenkhoa"><br>
				<label>Nội dung học </label>
				<textarea id="noidung" name="noidung">${khoahoc.khNoiDung}</textarea><br>
