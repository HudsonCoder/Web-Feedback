    ...
    <div id="content-wrapper">
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- DataTables Example -->
                <div class="card mb-3">
                    <form class="container" style="margin-top: 10px;" action="" method="post">
                        <h5 style="font-weight: bold;">Câu hỏi Online</h5>
                        <c:forEach items="${onlines}" var="cauhoi">
                            <div class="form-group">
                                <label for="usr">Câu hỏi ${cauhoi.thuTu}:</label>
                                <input type="text" name="online${cauhoi.thuTu}" class="form-control" id="usr" value="${cauhoi.noiDung}" content="123">
                            </div>
                        </c:forEach>
                        ...
                        <c:forEach items="${offlines}" var="cauhoi">
                            <div class="form-group">
                                <label for="usr-off">Câu hỏi ${cauhoi.thuTu}:</label>
                                <input name="offline${cauhoi.thuTu}" type="text" class="form-control" id="usr-off" value="${cauhoi.noiDung}">
                            </div>
                        </c:forEach>
                        ...
                        <c:forEach items="${seminars}" var="cauhoi">
                            <div class="form-group">
                                <label for="usr-se">Câu hỏi ${cauhoi.thuTu}:</label>
                                <input type="text" name="seminar${cauhoi.thuTu}" class="form-control" id="usr-se" value="${cauhoi.noiDung}">
                            </div>
                        </c:forEach>
