...
<title>Trang chủ - Cập Nhật Lớp Học</title>
			...
			<div class="content-wrapper">
				...
				<div class="container-fluid">
					...
					<div class="card mb-3">
						...
						<div class="card-body">
							<form id="update" action="/admin/editclasses" method="post"
								onsubmit="return check()">
								<h3>Cập nhật lớp học</h3>
								<div class="form-group">
									<label for="usr">Mã lớp:</label> <input value="${lophoc.maLop}"
										readonly name="malop" type="text" class="form-control"
										id="usr">
								</div>
								<div class="form-group">
									<label for="pwd">Tên lớp:</label> <input name="tenlop"
										value="${lophoc.tenLop}" class="form-control" id="tenlop"
										type="text" required
								...
								<div class="row row-space">
									<div class="col-6">
										<div class="form-group">
											<label>Tên giảng viên </label> <br> <select
