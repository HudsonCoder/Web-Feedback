...
<title>Trang chủ - Quản lý feedback</title>
		...
		<div id="content-wrapper">
			<div class="content-wrapper">
				...
				<div class="container-fluid">
					...
					<!-- Breadcrumbs-->
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="/admin/viewfeedback">Quản
								lý Feedback</a></li>
								...
								<table class="table table-bordered" id="dataTable" width="100%"
									...
									<thead>
										<tr>
											<th>Mã lớp học</th>
											<th>Tên lớp học</th>
											<th>Xem feedback online</th>
											<th>Xem feedback offline</th>
											<th>Xem feedback seminar</th>
										</tr>
									</thead>
									<tfoot>
										<tr>
									...
									<tbody>
										...
										<c:forEach items="${lops}" var="lop">
											<tr>
												...
												<td>${lop.tenLop}</td>
												<td>
													<form action='/admin/detail/online' method="get"
														class="btn-group btn-group-toggle" data-toggle="buttons">
														<input name="malop" value="${lop.maLop}"
															style="display: none;">
														<button class="btn" type="submit">
															<i class="fa fa-edit">Xem</i>
														</button>

													</form>
												</td>
												<td>
													<form action='/admin/detail/offline' method="get"
														class="btn-group btn-group-toggle" data-toggle="buttons">
														<input name="malop" value="${lop.maLop}"
															style="display: none;">
														<button class="btn" type="submit">
												...
												<td>
													<form action='/admin/detail/seminar' method="get"
														class="btn-group btn-group-toggle" data-toggle="buttons">
														<input name="malop" value="${lop.maLop}"
															style="display: none;">
														<button class="btn" type="submit">
