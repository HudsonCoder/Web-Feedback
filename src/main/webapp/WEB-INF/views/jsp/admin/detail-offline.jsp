										...
										<td>
											<table class="table table-bordered" id="dataTable"
												...
												<tbody>
													...
													<c:forEach items="${offlines}" var="offline"
														varStatus="count">
														<tr>
															<td>${count.count}</td>
															<td>${offline.ctCauHoi1}</td>
														</tr>
													</c:forEach>
...
<script src="https://cdn.datatables.net/buttons/1.6.2/js/buttons.html5.min.js"></script>
        ...
        var myPieChart4 = new Chart(ctx10, {
            type: 'pie',
            data: {
                datasets: [{
                    data: ${data[9].getData()},
