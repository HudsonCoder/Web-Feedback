...
<html>
<head>
    <title>Phản hồi khoá học Seminar 2020</title>
...
<%--        <img src="<logo.jpg>">--%>
    ...
    <input type="text" name="cauhoi3" class="in"required title="Dữ Liệu không được để trống"/>

    <h5>5. ${cauhois[3].noiDung} *</h5>
    <input type="text" name="cauhoi4" class="in"required title="Dữ Liệu không được để trống"/>
	...
	<div>
			...
			<input type="radio" value="1" name="cauhoi7">	<label for="ratingAccessibilityLabel.8-number-rating-5">1</label> <input
				...
				name="cauhoi7">	<label for="ratingAccessibilityLabel.8-number-rating-5">4</label> <input type="radio" value="5" name="cauhoi7">	<label for="ratingAccessibilityLabel.8-number-rating-5">5</label>
		</div>
